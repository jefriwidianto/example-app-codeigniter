                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                            <?php                                                        
                                            foreach ($listsurat_keluarselect->result() as $rows) {
                                            ?>
                                            <?php echo validation_errors(); ?>

                                            <?php echo form_open('surat_keluar/Update'); ?>
                                            
											<div class="form-group" hidden>
                                            <label>No Surat</label>
                                            <input type="text" name="id_surat_keluar"  class="form-control" placeholder="ID" value="<?= $rows->id_surat_keluar?>" hidden>
                                            </div>
											
                                            <div class="form-group">
                                            <label>No Surat</label>
                                            <input type="text" name="no_surat_keluar" class="form-control" placeholder="ID" value="<?= $rows->no_surat_keluar?>" readonly>
                                            </div>
                                            ...
                                            <textarea class="ckeditor" name="isi_surat" ><?= $rows->isi_surat?></textarea>
                                            </div>  
											...
											<div class="form-group">
                                            <label>Kepada</label>
                                            <input type="text" name="atas_nama" class="form-control" placeholder="" value="<?= $rows->atas_nama?>">
                                            </div>
                                            ...
                                            <a href="<?=base_url();?>index.php/surat_keluar"><input type="button" value="Cancel" class="btn btn-default"></a>
                                            </div>
                                            <?php echo form_close(); ?>
                                            <? } ?>  
                        </div>
