                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                            ...
                                            <?php echo form_open('kompetensi/Update'); ?>
                                            
                                            <div class="form-group">
                                            <label>ID pangkat</label>
                                            <input type="text" name="id_kompetensi" class="form-control" placeholder="ID kompetensi" value="<?= $rows->id_kompetensi?>" readonly>
                                            </div>

                                            <div class="form-group">
                                            <label>Name kompetensi</label>
                                            <input type="text" name="nm_kompetensi" class="form-control" placeholder="Name kompetensi" value="<?= $rows->nm_kompetensi?>">
                                            </div>    
