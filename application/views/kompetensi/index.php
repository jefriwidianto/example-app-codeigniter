                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
											...
											<?php echo form_open('kompetensi/insert'); ?>
											
											<div class="form-group">
                                            <label>Name kompetensi</label>
                                            <input type="text" name="nm_kompetensi" class="form-control" placeholder="Name kompetensi">
											</div>
											
											<div class="form-group">
                                            <label>Standarisasi</label>
                                            <input type="text" name="standarisasi" class="form-control" placeholder="">
											</div>
											
											<div class="form-group">
                                            <label>status</label>
                                            <select class="form-control" name="status">
                                            <option value="1" <?php echo set_select('myselect', '1', TRUE); ?> >status</option>
                                            <option value="0" <?php echo set_select('myselect', '0'); ?> >Destatus</option>
                                            </select> 
                                            </div>
                                        </div>
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                                        ...
                                                        foreach ($listkompetensi->result() as $rows) {
                                                    	?>
                                    										<tr>
                                    											<td><?= $rows->id_kompetensi?></td>
                                    											<td><?= $rows->nm_kompetensi?></td>
																				<td><?= $rows->standarisasi?></td>
